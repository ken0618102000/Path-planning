...
BEGIN_MESSAGE_MAP(CPathplanningApp, CWinApp)
...
CPathplanningApp::CPathplanningApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CPathplanningApp 物件

CPathplanningApp theApp;


// CPathplanningApp 初始設定

BOOL CPathplanningApp::InitInstance()
{
